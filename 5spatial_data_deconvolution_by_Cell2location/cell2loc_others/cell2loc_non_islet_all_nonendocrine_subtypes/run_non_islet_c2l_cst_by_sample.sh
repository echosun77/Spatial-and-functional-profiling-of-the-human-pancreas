...
#SBATCH --array=1-31          # Adjust based on total donor splits
...
#SBATCH -J c2l_train_cst_by_sample
...
echo "Node: $HOSTNAME | Job: ${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}"
python non_islet_c2l_cst_by_sample.py --sample "$SAMPLE_ID"
