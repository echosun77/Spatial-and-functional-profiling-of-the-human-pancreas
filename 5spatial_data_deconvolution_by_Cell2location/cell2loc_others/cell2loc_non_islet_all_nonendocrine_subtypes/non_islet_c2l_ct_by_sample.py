...
res_folder = f'../../results/cell2loc_non_islet/ct_c2l/{args.sample}'
...
plt.figure()
c2l.plot_history(10)
plt.savefig(f'{res_folder}/detection_non_islet_{args.sample}_ct.png', dpi=300)
...
spatial_file = f"{res_folder}/spatial_non_islet_after_c2l_{args.sample}_ct.h5ad"
spat.write(spatial_file)

plt.figure()
c2l.plot_QC()
plt.savefig(f'{res_folder}/c2l_non_islet_QC_{args.sample}_ct.png', dpi=300)
