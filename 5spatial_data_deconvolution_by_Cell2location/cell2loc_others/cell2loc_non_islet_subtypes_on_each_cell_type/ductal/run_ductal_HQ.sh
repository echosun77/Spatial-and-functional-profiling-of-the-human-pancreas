...
#SBATCH -t 0-3:00:00         # Time limit: 10 hours
#SBATCH -N 1 --gpus-per-node=A40:1  # Request 1 node with 1 A40 GPU
#SBATCH -o logs/20260102/%A_%a.out     # Save output logs in `logs/` directory, using job ID and array index
