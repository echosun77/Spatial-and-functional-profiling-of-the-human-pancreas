...
adata_merged = sc.read_h5ad(os.path.join(output_dir, 'non_islet_c2l_merged_ct.h5ad'))

# Optional sanity check
abund = adata_merged.obsm["q05_cell_abundance_w_sf"].copy() 

abund.to_csv(os.path.join(output_dir, 'q05_cell_abundance_w_sf_non_islet_c2l_ct.csv'), sep=',')
