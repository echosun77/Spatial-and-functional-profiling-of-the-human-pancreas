...
res_folder = f'../../results/cell2loc_non_islet/cst_c2l/HQ/'
...
spatial = spatial[spatial.obs['sample'].isin(high_quality_samples)].copy()
...
plt.figure()
c2l.plot_history(10)
plt.savefig(f'{res_folder}/detection_non_islet_alpha_20_HQ_cst.png', dpi=300)
...
spatial_file = f"{res_folder}/spatial_non_islet_after_c2l_HQ_cst.h5ad"
spat.write(spatial_file)

plt.figure()
c2l.plot_QC()
plt.savefig(f'{res_folder}/c2l_non_islet_QC_HQ_cst.png', dpi=300)
