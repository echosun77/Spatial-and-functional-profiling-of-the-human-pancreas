...
res_folder = f'../../results/cell2loc_extra_islets/LQ_samples/'
data_folder = '../../data/'
...
spatial_islet = spatial_islet[spatial_islet.obs['sample'].isin(low_quality_samples)].copy()
...
plt.figure()
c2l.plot_history(10)
plt.savefig(f'{res_folder}/detection_alpha_20_LQ.png', dpi=300)
...
spatial_file = f"{res_folder}/spatial_extra_islet_after_c2l_LQ.h5ad"
spat.write(spatial_file)

plt.figure()
c2l.plot_QC()
plt.savefig(f'{res_folder}/c2l_QC_LQ.png', dpi=300)
