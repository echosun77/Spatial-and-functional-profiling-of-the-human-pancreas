...
fig_folder = '../figures/'
res_folder = '../results/2500_epochs_batchsize_2048/'
data_folder = '../data/'
...
plt.figure()
c2l.plot_history(10)
plt.savefig(f'{res_folder}/detection_alpha_20.png', dpi=300)
...
spatial_file = f"{res_folder}/spatial_islet_after_c2l.h5ad"
spat.write(spatial_file)

plt.figure()
c2l.plot_QC()
plt.savefig(f'{res_folder}/c2l_QC.png', dpi=300)
